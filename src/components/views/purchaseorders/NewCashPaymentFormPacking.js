...
import { cashPaymentsPurchaseOrderPacking } from '../../../actions';

class NewCashPaymentFormPacking extends React.Component {
    ...
    onSubmit = (formValues) => {
        ...
        this.props.cashPaymentsPurchaseOrderPacking(this.props.purchaseOrder._id, formValues)
    }
    render() {
        return (
...
const formWrapped = reduxForm({
    form: 'purchaseOrderCashPaymentsPacking',
    validate: validate
})(NewCashPaymentFormPacking);
...
export default connect(mapStateToProps, { cashPaymentsPurchaseOrderPacking })(formWrapped);