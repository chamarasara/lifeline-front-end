...
import { fetchBankAccounts, additionalChargesBankPaymentsPurchaseOrderPacking } from '../../../actions';

class NewAdditionalBankPaymentFormPacking extends React.Component {
    componentDidMount() {
    ...
    onSubmit = (formValues) => {
        this.props.additionalChargesBankPaymentsPurchaseOrderPacking(this.props.purchaseOrder._id, { ...formValues, })
    }
    render() {
        return (
...
const formWrapped = reduxForm({
    form: 'purchaseOrderAdditionalBankPaymentsPacking',
    validate: validate
})(NewAdditionalBankPaymentFormPacking);
...
export default connect(mapStateToProps, { fetchBankAccounts, additionalChargesBankPaymentsPurchaseOrderPacking })(formWrapped);