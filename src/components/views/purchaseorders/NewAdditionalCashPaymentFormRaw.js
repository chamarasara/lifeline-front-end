...
import { additionalChargesCashPaymentsPurchaseOrderRaw } from '../../../actions';

class NewAdditionalCashPaymentFormRaw extends React.Component {
    ...
    onSubmit = (formValues) => {
        ...
        this.props.additionalChargesCashPaymentsPurchaseOrderRaw(this.props.purchaseOrder._id, formValues)
    }
    render() {
        return (
...
const formWrapped = reduxForm({
    form: 'purchaseOrderAdditionalCashPaymentsRaw',
    validate: validate
})(NewAdditionalCashPaymentFormRaw);
...
export default connect(mapStateToProps, { additionalChargesCashPaymentsPurchaseOrderRaw })(formWrapped);