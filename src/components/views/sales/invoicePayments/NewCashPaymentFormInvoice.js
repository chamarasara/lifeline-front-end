...
import { cashPaymentsInvoice } from '../../../../actions';

class NewCashPaymentFormInvoice extends React.Component {
    ...
    onSubmit = (formValues) => {
        ...
        this.props.cashPaymentsInvoice(this.props.purchaseOrder._id, formValues)
    }
    render() {
        return (
...
const formWrapped = reduxForm({
    form: 'invoiceCashPayments',
    validate: validate
})(NewCashPaymentFormInvoice);
...
export default connect(mapStateToProps, { cashPaymentsInvoice })(formWrapped);