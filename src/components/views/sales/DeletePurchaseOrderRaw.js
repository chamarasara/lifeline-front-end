...
import { fetchPurchaseOrderRaw, editPurchaseOrderRaw } from "../../../actions";
...
class DeletePurchaseOrderRaw extends React.Component {
    ...
    onSubmit = (formValues) => {
        ...
        this.props.editPurchaseOrderRaw(this.props.order._id, { ...formValues, order_state })
    }
    renderActions() {
       if (!this.props.order) {
           return(
...
export default connect(mapToSatate, { fetchPurchaseOrderRaw, editPurchaseOrderRaw })(formWrapped);