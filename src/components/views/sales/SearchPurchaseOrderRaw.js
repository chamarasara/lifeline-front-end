...
import { searchPurchaseOrdersRaw} from '../../../actions';

class SearchPurchaseOrderRaw extends React.Component {
    onClick = () => {
        window.location.reload()
    }
    onSubmit = (formvalues) => {
        console.log(formvalues)
        this.props.searchPurchaseOrdersRaw(formvalues)
    }
...
const formWrapped = reduxForm({
    form: 'searchPurchaseOrderRaw',
    validate: validate
})(SearchPurchaseOrderRaw);


export default connect(null, { searchPurchaseOrdersRaw})(formWrapped);
