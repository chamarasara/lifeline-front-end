...
import { fetchSuppliers, fetchRawMaterials, fetchPackingMaterials, createPurchaseOrder } from '../../../actions';
...
export default connect(mapStateToProps, { fetchSuppliers, fetchRawMaterials, fetchPackingMaterials, createPurchaseOrder })(formWrapped);