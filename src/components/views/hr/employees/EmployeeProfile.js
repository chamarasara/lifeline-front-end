                    ...
                    <div className="ui grid">
                        ...
                        <div className="fourteen wide column" style={{ marginTop: "30px" }}>
                            ...
                            <div style={{ paddingTop: "30px" }}>
                                <Link to={"/employee-dashboard"} className="ui button">
                                    Back
                            </Link>
                                <Link to={`/edit-employee/${this.props.employee._id}`} className="ui primary button">
                                    Edit
                            </Link>
                            </div>
                        </div>
...
export default connect(mapToSatate, { fetchEmployee })(EmployeeProfile);
