...
class EditEmployee extends React.Component {
    ...
    onSubmit = (formValues) => {
        this.props.editEmployee(this.props.employee._id, formValues)        
    }
    render() {
            ...
            <div className="pusher">
                <div className="ui basic segment" style={{ paddingLeft: "150px", paddingTop: "60px" }}>
                    ...
                    <form className="ui mini form error" onSubmit={this.props.handleSubmit(this.onSubmit)}>
                        ...
                        <div className="field">
                            <Link to={`/employee-profile/${this.props.match.params.id}`} className="ui button">Back</Link>
...
export default connect(mapStateToProps, { fetchEmployee, editEmployee,  })(formWrapped);