...
import { fetchPackingMaterial } from "../../../../actions";

class SinglePackingMaterial extends React.Component {
    componentDidMount() {
            ...
            <div key={mrpOne._id}>
                <table className="ui celled small padded compact structured table">
                    ...
                    <tfoot className="full-width">
                        <tr>
                            <th colSpan="25">
                                <Link to={`/edit-packing-material-mrp-one/${this.props.material._id}`} className="ui small primary button">
                                    Edit
                                    </Link>
                            </th>
                        </tr>
            ...
            <div key={mrpTwo._id}>
                <table className="ui celled small padded compact structured table">
                    ...
                    <tfoot className="full-width">
                        <tr>
                            <th colSpan="25">
                                <Link to={`/edit-packing-material-mrp-two/${this.props.material._id}`} className="ui small primary button">
                                    Edit
                                    </Link>
                            </th>
                        </tr>
            ...
            <div key={mrpThree._id}>
                <table className="ui celled small padded compact structured table">
                    ...
                    <tfoot className="full-width">
                        <tr>
                            <th colSpan="25">
                                <Link to={`/edit-packing-material-mrp-three/${this.props.material._id}`} className="ui small primary button">
                                    Edit
                                    </Link>
                            </th>
                        </tr>
            ...
            <div key={mrpFour._id}>
                <table className="ui celled small padded compact structured table">
                    ...
                    <tfoot className="full-width">
                        <tr>
                            <th colSpan="25">
                                <Link to={`/edit-packing-material-mrp-four/${this.props.material._id}`} className="ui small primary button">
                                    Edit
                                    </Link>
                            </th>
                        </tr>
    ...
    render() {
        if (!this.props.material) {
            return <div>Please select a Packing Material</div>
        }
        return (
...
const mapToSatate = (state, ownPorps) => {
    console.log(state.packingMaterials[ownPorps.match.params.id])
    return { material: state.packingMaterials[ownPorps.match.params.id] };
}
export default connect(mapToSatate, { fetchPackingMaterial })(SinglePackingMaterial);
