...
class RawMaterialMrpOne extends React.Component{
            ...
            <div className="pusher">
                <div className="ui basic segment" style={{ paddingLeft: "150px", paddingTop: "60px" }}>
                    ...
                    <h4>General Data</h4>
                        ...
                        <div className="field">
                            <Link to={"/new-raw-material"} className="ui  button">Previous</Link>
