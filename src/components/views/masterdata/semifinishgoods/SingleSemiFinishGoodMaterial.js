...
import { fetchSemiFinishGood } from "../../../../actions";

class SingleSemiFinishGoodMaterial extends React.Component {
    componentDidMount() {
            ...
            <div key={mrpOne._id}>
                <table className="ui celled small padded compact structured table">
                    <thead className="full-width">
                        <tr>
                            <th colSpan="8" style={{ color: "red" }}><h4>MRP One</h4></th>
                        </tr>
                        <tr>
                            <th colSpan="8" style={{ color: "blue" }}>General Data</th>
                        </tr>
                        <tr>
                            <th colSpan="2">ABC Indicator</th>
                            <th>Base Unit</th>
                    ...
                    <tbody>
                        <tr>
                            <td colSpan="2">{mrpOne.generalData.abcIndicator}</td>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td colSpan="2">{mrpOne.mrpProcedure.planningCycle}</td>
                            <td>{mrpOne.mrpProcedure.mrpController}</td>
                        </tr>
                    </tbody>
                    <thead className="full-width">
                        <tr>
                            <th colSpan="8" style={{ color: "blue" }}>Lot Size Data</th>
                        </tr>
                        <tr>
                            <th>Lot Size</th>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>{mrpOne.lotSizeData.maximumStockLevel}</td>
                    ...
                    <tfoot className="full-width">
                        <tr>
                            <th colSpan="25">
                                <Link to={`/edit-semi-finish-good-mrp-one/${this.props.material._id}`} className="ui small primary button">
                                    Edit
                                    </Link>
                            </th>
                        </tr>
            ...
            <div key={mrpTwo._id}>
                <table className="ui celled small padded compact structured table">
                    ...
                    <tfoot className="full-width">
                        <tr>
                            <th colSpan="25">
                                <Link to={`/edit-semi-finish-good-mrp-two/${this.props.material._id}`} className="ui small primary button">
                                    Edit
                                    </Link>
                            </th>
                        </tr>
            ...
            <div key={mrpThree._id}>
                <table className="ui celled small padded compact structured table">
                    ...
                    <tfoot className="full-width">
                        <tr>
                            <th colSpan="25">
                                <Link to={`/edit-semi-finish-good-mrp-three/${this.props.material._id}`} className="ui small primary button">
                                    Edit
                                    </Link>
                            </th>
                        </tr>
            ...
            <div key={mrpFour._id}>
                <table className="ui celled small padded compact structured table">
                    ...
                    <tfoot className="full-width">
                        <tr>
                            <th colSpan="25">
                                <Link to={`/edit-semi-finish-good-mrp-four/${this.props.material._id}`} className="ui small primary button">
                                    Edit
                                    </Link>
                            </th>
                        </tr>
            ...
            <div key={plantDataOne._id}>
                <table className="ui celled small padded compact structured table">
                    ...
                    <tfoot className="full-width">
                        <tr>
                            <th colSpan="25">
                                <Link to={`/edit-semi-finish-good-plant-one/${this.props.material._id}`} className="ui small primary button">
                                    Edit
                                    </Link>
                            </th>
                        </tr>
            ...
            <div key={plantDataTwo._id}>
                <table className="ui celled small padded compact structured table">
                    ...
                    <tfoot className="full-width">
                        <tr>
                            <th colSpan="25">
                                <Link to={`/edit-semi-finish-good-plant-two/${this.props.material._id}`} className="ui small primary button">
                                    Edit
                                    </Link>
                            </th>
                        </tr>
                ...
                <div className="ui basic segment" style={{ paddingLeft: "150px", paddingTop: "80px" }}>
                    <div className="ui grid">
                        <div className="sixteen wide column" style={{ marginTop: "0px" }}>
                            <Link to={"/semi-finish-goods"} className="ui small button">
                                Back
                        </Link>
                            <Link to={`/delete-semi-finish-good-material/${this.props.material._id}`} className="ui small red button">
                                Delete
                        </Link>
                            <table className="ui celled structured table">
                                ...
                                <tfoot className="full-width">
                                    <tr>
                                        <th colSpan="12">
                                            <Link to={`/semi-finish-good-edit-details/${this.props.material._id}`} className="ui small primary button">
                                                Edit
                                            </Link>
                                        </th>
                                    </tr>
