...
class EditSemiFinishGoodMaterialPlantOne extends React.Component {
    componentDidMount() {
...
const mapStateToProps = (state, ownPorps) => {
    return { material: state.semiFinishGoods[ownPorps.match.params.id], initialValues: state.semiFinishGoods[ownPorps.match.params.id] };
}
const formWrapped = reduxForm({
    form: 'editSemiFinishGoodMaterialPlantOne',
    destroyOnUnmount: false,
    forceUnregisterOnUnmount: true
})(EditSemiFinishGoodMaterialPlantOne);
